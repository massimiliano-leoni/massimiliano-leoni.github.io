...
- MSc in Mathematical Engineering, Politecnico di Milano (2016)
- Master's thesis at Rolls-Royce (2015)
- Double PhD in Computer Science (KTH) and Mathematics (UPV/EHU) (2020)
- Research Scientist at the Austrian Academy of Sciences
- Software engineer at Proxima Fusion

## Three selected projects

- Modelling and simulation of Extra-Corporeal Membrane Oxygenation
- Cardiac Radiofrequency Ablation and function interpolation
- Thermal analysis of a first wall

# Modelling and Simulation of Extracorporeal Membrane Oxygenation (ECMO)
...
## Approach
- Developed a Finite Element model of cardiovascular flow dynamics and oxygen transport  
- Incorporated cannulation geometry, machine characteristics, and patient physiology
...
## Impact
- Provided clinicians with an explanation for observed oxygenation limits
